  ...
  */
  head: {
    ...
    meta: [
      ...
      { property: 'og:title', content: 'SW Google KG Quiz' },
      { property: 'og:description', name: 'description', content: 'SW Google KG Quiz' },
      { property: 'og:url', content: '89.221.219.40/sw' },
